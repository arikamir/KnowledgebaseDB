...
output "github_actions_delivery_identity_manifest" { value = { publisher = { resource_id = azurerm_user_assigned_identity.github_actions_publisher.id, client_id = azurerm_user_assigned_identity.github_actions_publisher.client_id }, validator = null, ui = null, contract = local.delivery_identity_contract } }
